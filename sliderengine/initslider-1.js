jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        transition:"tiles,slice,elastic,threedflipwithzoom,threedwithzoom,flip,threedflip,cssslide,threedtiles,crossfade,kenburns,threedhorizontalwithzoom,fade,flipwithzoom,threedhorizontal,blinds,threed",
        scalemode:"fill",
        isfullscreen:false,
        textformat: {
